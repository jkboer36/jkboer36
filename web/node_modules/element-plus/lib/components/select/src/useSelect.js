...
const useSelect = (props, states, ctx) => {
  ...
  const resetInputHeight = () => {
    ...
    vue.nextTick(() => {
      ...
      const sizeInMap = states.initialInputHeight || size.getComponentSize(selectSize.value || elForm.size);
  ...
  const getOption = (value) => {
    ...
    for (let i = states.cachedOptions.size - 1; i >= 0; i--) {
      ...
      const isEqualValue = isObjectValue ? lodashUnified.get(cachedOption, props.valueKey) === lodashUnified.get(value, props.valueKey) : cachedOption.value === value;
      if (isEqualValue) {
        option = {
          value,
